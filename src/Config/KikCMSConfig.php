...
class KikCMSConfig
{
    ...
    const NAMESPACE_PATH_PHALCON_VALIDATORS        = 'Phalcon\\Filter\\Validation\\Validator\\';
    const NAMESPACE_PATH_CUSTOM_PHALCON_VALIDATORS = 'KikCMS\\Classes\\Phalcon\\Validator\\';
