...
return [
    ...
    'spamBlock' => [
        "q1"  => "Kleur van heldere lucht?",
        "q2"  => "Kleur van gras?",
        "q3"  => "Kleur van een banaan?",
        "q4"  => "Kleur van sinaasappels?",
        "q5"  => "Kleur van een tomaat?",
        "q6"  => "Kleur van sneeuw?",
        "q7"  => "Kleur als rood en wit mengt?",
        "q8"  => "Kleur van een citroen?",
        "q9"  => "Kleur van chocola?",
        "q10" => "Kleur van een aardbei?",
        "q11" => "Kleur van een flamingo?",
        "q12" => "Kleur van de zon?",
        "q13" => "Kleur als blauw en rood mengt?",
        "q14" => "Kleur van sla?",
        ...
        "q21" => "Kleur van blauwe bessen?",
        "q22" => "Kleur van krokodillen?",
        "q23" => "Kleur van melk?",
        "q24" => "Kleur van een tennisbal?",
        "q25" => "Kleur van een brandweerwagen?",
        "q26" => "Kleur van ketchup?",
        "q27" => "Kleur van een herfstblad?",
        "q28" => "Kleur van een avocado?",
        "q29" => "Kleur van de ruimte?",
        "q30" => "Kleur van een lieveheersbeestje?",
