...
return [
    ...
    'webform' => [
        'messages' => [
            ...
            'FileResolutionEqual' => "Het bestand :label mag geen hogere resolutie hebben dan :max",
            'FileResolutionMax'   => "Het bestand :label mag geen hogere resolutie hebben dan :max",
            'FileResolutionMin'   => "Het bestand :label moet tenminste een resolutie van :min hebben",
