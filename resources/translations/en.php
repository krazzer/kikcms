...
return [
    ...
    'spamBlock' => [
        ...
        "q13" => "What color do you get when you mix blue and red?",
        "q14" => "What color is lettuce?",
        "q15" => "What color is a carrot?",
        "q16" => "What color are roses?",
        "q17" => "What color are leaves in autumn?",
        "q18" => "What color do you get when you mix yellow and blue?",
        "q19" => "What color is a walnut?",
        "q20" => "What color are cherries?",
        "q21" => "What color are blueberries?",
        "q22" => "What color are crocodiles?",
        "q23" => "What color is milk?",
        "q24" => "What color is a tennis ball?",
        "q25" => "What color is a fire truck?",
        "q26" => "What color is ketchup?",
        "q27" => "What color is an autumn leaf?",
        "q28" => "What color is an avocado?",
        "q29" => "What color is space?",
        "q30" => "What color is a ladybug?",
